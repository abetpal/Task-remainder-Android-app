...
import remainder.abhinav.com.taskremainder.Alarm;
import remainder.abhinav.com.taskremainder.AlarmReceiver;
import remainder.abhinav.com.taskremainder.AlarmListAdapter;
import remainder.abhinav.com.taskremainder.About;
...
public class AlarmMe extends Activity
{
  ...
  public void onCreate(Bundle bundle)
  {
    ...
    Log.i(TAG, "TaskRemainder.onCreate()");
  ...
  {
    super.onDestroy();
    Log.i(TAG, "TaskRemainder.onDestroy()");
  ...
  {
    super.onResume();
    Log.i(TAG, "TaskRemainder.onResume()");
